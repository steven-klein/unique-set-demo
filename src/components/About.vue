<template>
  <div class="about">
    ...
    <p>Depending on the source and reliability of the input data we may need to also consider the case where addresses may exists with varying letter cases: <a href="mailto:STEVEN@example.com">STEVEN@example.com</a>, <a href="mailto:steven@example.com">steven@example.com</a>, <a href="mailto:steven@EXAMPLE.COM">steven@EXAMPLE.COM</a>.  These implementations do not check against this and makes the assumption the input data as been normalized in some way and they would all be considered unique.</p>
